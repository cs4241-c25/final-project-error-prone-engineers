        ...
        <div>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-[url('/freedomtrail_medallion.jpg')] bg-cover bg-center">
                <div className="bg-white p-4 rounded-3xl w-3/5 h-4/5">
                    <h2 className="text-3xl font-bold font-cinzel_decorative text-blue-900 text-center mb-4">Review Pending Business Owners</h2>
                    <table className="w-full font-garamond">
                        ...
                        {pendingUsers.map((user) => (
                            <tr key={user._id}>
                                ...
                                <td className="p-2 border bg-[#DCEDFF] text-center">
                                    <button
